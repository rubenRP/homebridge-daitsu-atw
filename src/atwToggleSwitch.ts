...
export class ATWToggleSwitch {
  private readonly Service: typeof Service =
    this.parent.platform.api.hap.Service;

  private readonly Characteristic: typeof Characteristic =
    this.parent.platform.api.hap.Characteristic;

  public service: Service;

  constructor(
    private parent: DaitsuATW,
    private attribute: SwitchName,
    private displayName: string,
  ) {
    this.service =
      this.parent.accessory.getService(this.displayName) ||
